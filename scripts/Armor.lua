...
kattArmor.Armor.Chestplate
	:addParts(
		...
		upperRoot.Body.RightArm.rightArmArmor.Chestplate,
		upperRoot.Body.LeftArm.leftArmArmor.Chestplate,
	...
	:addTrimParts(
		...
		upperRoot.Body.RightArm.rightArmArmor.ChestplateTrim,
		upperRoot.Body.LeftArm.leftArmArmor.ChestplateTrim,
...
kattArmor.Materials.leather
	...
	:addParts(kattArmor.Armor.Chestplate,
		...
		upperRoot.Body.RightArm.rightArmArmor.ChestplateLeather,
		upperRoot.Body.LeftArm.leftArmArmor.ChestplateLeather,
